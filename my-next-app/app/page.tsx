    ...
    <main>
      ...
      <BannerLayout>
        ...
        <div className="flex justify-center w-full mt-8">
          <a
            href="#"
            className="inline-flex items-center uppercase justify-center px-[51px] py-[18px] font-bold text-[22px] rounded-[500px] bg-gradient-to-r from-[#BB57BF] via-[#2E4B94] to-[#2CC8D8] text-white"
          >
            Join The Stampede
            <svg
