...
export default function TokenTabsWithIframe() {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center gap-6 px-4 py-10 bg-[url('/upper-home.png')] bg-lightgray bg-cover bg-no-repeat bg-blend-multiply pt-[55px] pb-[200px] sm:pb-[130px]">
      {/* Tabs */}
      ...
      {activeTab === 'buy' && (
        <div className="flex justify-center w-full mx-4">
          <div className="px-4 py-4 m-5  bg-white/10 text-center rounded-lg">
          <div className="rounded-lg h-[500px] w-[370px] overflow-hidden shadow-[0_4px_10px_rgba(0,0,0,0.1)]">
            <iframe
